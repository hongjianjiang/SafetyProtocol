...
mu_flag1 = mu_false;
bool mu__boolexpr20;
  if (!((mu_msg.mu_msgType) == (mu_key))) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = ((mu_msg.mu_k.mu_encType) == (mu_PK)) ; 
}
if ( mu__boolexpr20 )
{
mu_flag1 = mu_true;
...
mu_i = 1;
{
  bool mu__while_expr_22;  mu__while_expr_22 = (mu_i) <= (mu_msg_end);
...
{
bool mu__boolexpr23;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_key))) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = ((mu_msgs[mu_i].mu_k.mu_encType) == (mu_PK)) ; 
}
if ( mu__boolexpr23 )
{
...
mu__while_expr_22 = (mu_i) <= (mu_msg_end);
}
};
if ( (mu_index) == (0) )
{
...
{
bool mu__boolexpr24;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_i1))) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = ((mu_msgs[mu_i].mu_aencKey) == (mu_i2)) ; 
}
if ( mu__boolexpr24 )
{
mu_index = mu_i;
...
bool mu__boolexpr25;
  if (!(mu_flagPart1)) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = (mu_flagPart2) ; 
}
if ( mu__boolexpr25 )
{
mu_flag1 = mu_true;
...
{
bool mu__boolexpr28;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_i1))) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = ((mu_msgs[mu_i].mu_aencKey) == (mu_i2)) ; 
}
if ( mu__boolexpr28 )
{
if (mu_i.isundefined())
...
bool mu__boolexpr50;
bool mu__boolexpr51;
  if (!((mu_msg.mu_msgType) == (mu_agent))) mu__boolexpr51 = FALSE ;
  else {
  mu__boolexpr51 = ((mu_msgs[mu_i].mu_ag) == (mu_msg.mu_ag)) ; 
}
  if (mu__boolexpr51) mu__boolexpr50 = TRUE ;
  else {
bool mu__boolexpr52;
  if (!((mu_msg.mu_msgType) == (mu_nonce))) mu__boolexpr52 = FALSE ;
  else {
  mu__boolexpr52 = ((mu_msgs[mu_i].mu_noncePart) == (mu_msg.mu_noncePart)) ; 
}
...
bool mu__boolexpr53;
  if (!((mu_msg.mu_msgType) == (mu_key))) mu__boolexpr53 = FALSE ;
  else {
bool mu__boolexpr54;
bool mu__boolexpr55;
  if (!((mu_msgs[mu_i].mu_k.mu_encType) == (mu_msg.mu_k.mu_encType))) mu__boolexpr55 = FALSE ;
  else {
  mu__boolexpr55 = ((mu_msg.mu_k.mu_encType) != (mu_Symk)) ; 
}
  if (!(mu__boolexpr55)) mu__boolexpr54 = FALSE ;
  else {
  mu__boolexpr54 = ((mu_msgs[mu_i].mu_k.mu_ag) == (mu_msg.mu_k.mu_ag)) ; 
}
  mu__boolexpr53 = (mu__boolexpr54) ; 
}
  mu__boolexpr49 = (mu__boolexpr53) ; 
}
  if (mu__boolexpr49) mu__boolexpr48 = TRUE ;
  else {
bool mu__boolexpr56;
  if (!((mu_msg.mu_msgType) == (mu_key))) mu__boolexpr56 = FALSE ;
  else {
bool mu__boolexpr57;
bool mu__boolexpr58;
bool mu__boolexpr59;
  if (!((mu_msgs[mu_i].mu_k.mu_encType) == (mu_msg.mu_k.mu_encType))) mu__boolexpr59 = FALSE ;
  else {
  mu__boolexpr59 = ((mu_msg.mu_k.mu_encType) == (mu_Symk)) ; 
}
  if (!(mu__boolexpr59)) mu__boolexpr58 = FALSE ;
  else {
  mu__boolexpr58 = ((mu_msgs[mu_i].mu_k.mu_ag1) == (mu_msg.mu_k.mu_ag1)) ; 
}
  if (!(mu__boolexpr58)) mu__boolexpr57 = FALSE ;
  else {
  mu__boolexpr57 = ((mu_msgs[mu_i].mu_k.mu_ag2) == (mu_msg.mu_k.mu_ag2)) ; 
}
  mu__boolexpr56 = (mu__boolexpr57) ; 
}
  mu__boolexpr48 = (mu__boolexpr56) ; 
}
  if (mu__boolexpr48) mu__boolexpr47 = TRUE ;
  else {
bool mu__boolexpr60;
  if (!((mu_msg.mu_msgType) == (mu_aenc))) mu__boolexpr60 = FALSE ;
  else {
bool mu__boolexpr61;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_msg.mu_aencMsg))) mu__boolexpr61 = FALSE ;
  else {
  mu__boolexpr61 = ((mu_msgs[mu_i].mu_aencKey) == (mu_msg.mu_aencKey)) ; 
}
  mu__boolexpr60 = (mu__boolexpr61) ; 
}
  mu__boolexpr47 = (mu__boolexpr60) ; 
}
  if (mu__boolexpr47) mu__boolexpr46 = TRUE ;
  else {
bool mu__boolexpr62;
  if (!((mu_msg.mu_msgType) == (mu_senc))) mu__boolexpr62 = FALSE ;
  else {
bool mu__boolexpr63;
  if (!((mu_msgs[mu_i].mu_sencMsg) == (mu_msg.mu_sencMsg))) mu__boolexpr63 = FALSE ;
  else {
  mu__boolexpr63 = ((mu_msgs[mu_i].mu_sencKey) == (mu_msg.mu_sencKey)) ; 
}
  mu__boolexpr62 = (mu__boolexpr63) ; 
}
  mu__boolexpr46 = (mu__boolexpr62) ; 
}
if ( mu__boolexpr46 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr64;
  if (!((mu_msg.mu_msgType) == (mu_concat))) mu__boolexpr64 = FALSE ;
  else {
  mu__boolexpr64 = ((mu_msg.mu_length) == (mu_msgs[mu_i].mu_length)) ; 
}
if ( mu__boolexpr64 )
{
...
mu_flag = mu_true;
{
  bool mu__while_expr_66;  mu__while_expr_66 = (mu_j) > (0);
...
mu_i = 1;
{
  bool mu__while_expr_68;  mu__while_expr_68 = (mu_i) < (mu_msg.mu_length);
...
mu__while_expr_68 = (mu_i) < (mu_msg.mu_length);
}
};
mu_printMsg ( mu_msgs[mu_msg.mu_concatPart[mu_i]] );
cout << ")";
...
{
bool mu__boolexpr69;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_agent))) mu__boolexpr69 = FALSE ;
  else {
  mu__boolexpr69 = ((mu_msgs[mu_i].mu_ag) == (mu_msg.mu_ag)) ; 
}
if ( mu__boolexpr69 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr70;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_nonce))) mu__boolexpr70 = FALSE ;
  else {
  mu__boolexpr70 = ((mu_msgs[mu_i].mu_noncePart) == (mu_msg.mu_noncePart)) ; 
}
if ( mu__boolexpr70 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr71;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_key))) mu__boolexpr71 = FALSE ;
  else {
bool mu__boolexpr72;
  if (!((mu_msgs[mu_i].mu_k.mu_encType) == (mu_msg.mu_k.mu_encType))) mu__boolexpr72 = FALSE ;
  else {
  mu__boolexpr72 = ((mu_msgs[mu_i].mu_k.mu_ag) == (mu_msg.mu_k.mu_ag)) ; 
}
...
{
bool mu__boolexpr73;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_aenc))) mu__boolexpr73 = FALSE ;
  else {
bool mu__boolexpr74;
  if (!((mu_msgs[mu_i].mu_aencKey) == (mu_msg.mu_aencKey))) mu__boolexpr74 = FALSE ;
  else {
  mu__boolexpr74 = ((mu_msgs[mu_i].mu_aencMsg) == (mu_msg.mu_aencMsg)) ; 
}
...
{
bool mu__boolexpr75;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_senc))) mu__boolexpr75 = FALSE ;
  else {
bool mu__boolexpr76;
  if (!((mu_msgs[mu_i].mu_sencKey) == (mu_msg.mu_sencKey))) mu__boolexpr76 = FALSE ;
  else {
  mu__boolexpr76 = ((mu_msgs[mu_i].mu_sencMsg) == (mu_msg.mu_sencMsg)) ; 
}
...
bool mu__boolexpr78;
  if (!((mu_msgs[mu_i].mu_concatPart[1]) == (mu_msg.mu_concatPart[1]))) mu__boolexpr78 = FALSE ;
  else {
  mu__boolexpr78 = ((mu_msgs[mu_i].mu_concatPart[2]) == (mu_msg.mu_concatPart[2])) ; 
}
...
{
bool mu__boolexpr81;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_msgNo3))) mu__boolexpr81 = FALSE ;
  else {
...
for(int mu_i = 0; mu_i <= 100; mu_i++) {
bool mu__boolexpr82;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_concat))) mu__boolexpr82 = FALSE ;
  else {
  mu__boolexpr82 = ((mu_msgs[mu_i].mu_length) == (2)) ; 
}
if ( mu__boolexpr82 )
{
bool mu__boolexpr83;
  if (!((mu_msgs[mu_i].mu_concatPart[1]) == (mu_msgNo1))) mu__boolexpr83 = FALSE ;
  else {
  mu__boolexpr83 = ((mu_msgs[mu_i].mu_concatPart[2]) == (mu_msgNo2)) ; 
}
if ( mu__boolexpr83 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr84;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_msgNo6))) mu__boolexpr84 = FALSE ;
  else {
  mu__boolexpr84 = ((mu_msgs[mu_i].mu_aencKey) == (mu_msgNo4)) ; 
}
if ( mu__boolexpr84 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr85;
  if (!((mu_msgs[mu_i].mu_aencMsg) == (mu_msgNo1))) mu__boolexpr85 = FALSE ;
  else {
  mu__boolexpr85 = ((mu_msgs[mu_i].mu_aencKey) == (mu_msgNo4)) ; 
}
if ( mu__boolexpr85 )
{
mu_index = mu_i;
...
bool mu__boolexpr86;
  if (!((mu_msgNo) != (0))) mu__boolexpr86 = FALSE ;
  else {
  mu__boolexpr86 = ((mu_PatnSet.mu_content[mu_i]) == (mu_msgNo)) ; 
}
if ( mu__boolexpr86 )
{
mu_flag = mu_true;
...
bool mu__boolexpr87;
  if (!((mu_m1.mu_msgType) == (mu_agent))) mu__boolexpr87 = FALSE ;
  else {
  mu__boolexpr87 = ((mu_m2.mu_msgType) == (mu_agent)) ; 
}
if ( mu__boolexpr87 )
{
...
{
bool mu__boolexpr88;
  if (!((mu_m1.mu_msgType) == (mu_nonce))) mu__boolexpr88 = FALSE ;
  else {
  mu__boolexpr88 = ((mu_m2.mu_msgType) == (mu_nonce)) ; 
}
if ( mu__boolexpr88 )
{
...
{
bool mu__boolexpr89;
  if (!((mu_m1.mu_msgType) == (mu_key))) mu__boolexpr89 = FALSE ;
  else {
  mu__boolexpr89 = ((mu_m2.mu_msgType) == (mu_key)) ; 
}
if ( mu__boolexpr89 )
{
...
{
bool mu__boolexpr90;
  if (!((mu_m1.mu_k.mu_encType) == (mu_m2.mu_k.mu_encType))) mu__boolexpr90 = FALSE ;
  else {
  mu__boolexpr90 = (mu_matchAgent( mu_m1.mu_k.mu_ag, mu_m2.mu_k.mu_ag )) ; 
}
...
{
bool mu__boolexpr91;
  if (!((mu_m1.mu_k.mu_encType) == (mu_m2.mu_k.mu_encType))) mu__boolexpr91 = FALSE ;
  else {
  mu__boolexpr91 = (mu_matchAgent( mu_m1.mu_k.mu_ag, mu_m2.mu_k.mu_ag )) ; 
}
...
bool mu__boolexpr93;
  ...
  mu__boolexpr93 = (mu_matchAgent( mu_m1.mu_k.mu_ag1, mu_m2.mu_k.mu_ag1 )) ; 
}
  if (!(mu__boolexpr93)) mu__boolexpr92 = FALSE ;
  else {
  mu__boolexpr92 = (mu_matchAgent( mu_m1.mu_k.mu_ag2, mu_m2.mu_k.mu_ag2 )) ; 
}
...
{
bool mu__boolexpr94;
  if (!((mu_m1.mu_msgType) == (mu_aenc))) mu__boolexpr94 = FALSE ;
  else {
  mu__boolexpr94 = ((mu_m2.mu_msgType) == (mu_aenc)) ; 
}
if ( mu__boolexpr94 )
{
bool mu__boolexpr95;
  if (!(mu_match( mu_msgs[mu_m1.mu_aencMsg], mu_msgs[mu_m2.mu_aencMsg] ))) mu__boolexpr95 = FALSE ;
  else {
  mu__boolexpr95 = (mu_match( mu_msgs[mu_m1.mu_aencKey], mu_msgs[mu_m2.mu_aencKey] )) ; 
}
...
{
bool mu__boolexpr96;
  if (!((mu_m1.mu_msgType) == (mu_senc))) mu__boolexpr96 = FALSE ;
  else {
  mu__boolexpr96 = ((mu_m2.mu_msgType) == (mu_senc)) ; 
}
if ( mu__boolexpr96 )
{
bool mu__boolexpr97;
  if (!(mu_match( mu_msgs[mu_m1.mu_sencMsg], mu_msgs[mu_m2.mu_sencMsg] ))) mu__boolexpr97 = FALSE ;
  else {
  mu__boolexpr97 = (mu_match( mu_msgs[mu_m1.mu_sencKey], mu_msgs[mu_m2.mu_sencKey] )) ; 
}
...
bool mu__boolexpr98;
bool mu__boolexpr99;
  if (!((mu_m1.mu_msgType) == (mu_concat))) mu__boolexpr99 = FALSE ;
  else {
  mu__boolexpr99 = ((mu_m2.mu_msgType) == (mu_concat)) ; 
}
  if (!(mu__boolexpr99)) mu__boolexpr98 = FALSE ;
  else {
  mu__boolexpr98 = ((mu_m1.mu_length) == (mu_m2.mu_length)) ; 
}
if ( mu__boolexpr98 )
{
...
bool mu__boolexpr102;
  if (!((mu_i) > (0))) mu__boolexpr102 = FALSE ;
  else {
  mu__boolexpr102 = (mu_concatFlag) ; 
}
{
  bool mu__while_expr_101;  mu__while_expr_101 = mu__boolexpr102;
...
bool mu__boolexpr103;
  if (!(mu_concatFlag)) mu__boolexpr103 = FALSE ;
  else {
  mu__boolexpr103 = (mu_match( mu_msgs[mu_m1.mu_concatPart[mu_i]], mu_msgs[mu_m2.mu_concatPart[mu_i]] )) ; 
}
mu_concatFlag = mu__boolexpr103;
mu_i = (mu_i) - (1);
};
bool mu__boolexpr104;
  if (!((mu_i) > (0))) mu__boolexpr104 = FALSE ;
  else {
  mu__boolexpr104 = (mu_concatFlag) ; 
}
mu__while_expr_101 = mu__boolexpr104;
}
};
...
mu_i = 1;
{
  bool mu__while_expr_106;  mu__while_expr_106 = (mu_i) < ((mu_sPatnSet.mu_length) + (1));
...
mu__while_expr_106 = (mu_i) < ((mu_sPatnSet.mu_length) + (1));
}
};
return mu_flag;
...
bool mu__boolexpr120;
  if (!((mu_i) <= (mu_pat1Set.mu_length))) mu__boolexpr120 = FALSE ;
  else {
  mu__boolexpr120 = ((mu_pat1Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr120)) mu__boolexpr119 = FALSE ;
  else {
  mu__boolexpr119 = (mu_Spy_known[mu_pat1Set.mu_content[mu_i]]) ; 
}
  ...
  mu__boolexpr115 = (mu_matchPat( mu_msgs[mu_construct8By14( mu_pat1Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )], mu_sPat8Set )) ; 
}
  if (!(mu__boolexpr115)) mu__boolexpr114 = FALSE ;
  else {
  mu__boolexpr114 = (!(mu_Spy_known[mu_construct8By14( mu_pat1Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )])) ; 
}
	      if (mu__boolexpr114) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr123;
  if (!((mu_i) <= (mu_pat8Set.mu_length))) mu__boolexpr123 = FALSE ;
  else {
  mu__boolexpr123 = ((mu_pat8Set.mu_content[mu_i]) != (0)) ; 
}
  ...
  mu__boolexpr121 = (!(mu_Spy_known[mu_msgs[mu_pat8Set.mu_content[mu_i]].mu_aencMsg])) ; 
}
...
bool mu__boolexpr126;
  if (!((mu_i) <= (mu_pat8Set.mu_length))) mu__boolexpr126 = FALSE ;
  else {
  mu__boolexpr126 = ((mu_pat8Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr126)) mu__boolexpr125 = FALSE ;
  else {
  mu__boolexpr125 = (mu_Spy_known[mu_pat8Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr125)) mu__boolexpr124 = FALSE ;
  else {
  mu__boolexpr124 = (!(mu_Spy_known[mu_msgs[mu_pat8Set.mu_content[mu_i]].mu_aencMsg])) ; 
}
	      if (mu__boolexpr124) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr140;
  ...
  mu__boolexpr138 = ((mu_j) <= (mu_pat4Set.mu_length)) ; 
}
  if (!(mu__boolexpr138)) mu__boolexpr137 = FALSE ;
  else {
  mu__boolexpr137 = ((mu_pat4Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr137)) mu__boolexpr136 = FALSE ;
  else {
  mu__boolexpr136 = (mu_Spy_known[mu_pat4Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr136)) mu__boolexpr135 = FALSE ;
  else {
  mu__boolexpr135 = (mu_matchPat( mu_msgs[mu_construct7By64( mu_pat6Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )], mu_sPat7Set )) ; 
}
  if (!(mu__boolexpr135)) mu__boolexpr134 = FALSE ;
  else {
  mu__boolexpr134 = (!(mu_Spy_known[mu_construct7By64( mu_pat6Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )])) ; 
}
	      if (mu__boolexpr134) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr143;
  if (!((mu_i) <= (mu_pat7Set.mu_length))) mu__boolexpr143 = FALSE ;
  else {
  ...
  mu__boolexpr141 = (!(mu_Spy_known[mu_msgs[mu_pat7Set.mu_content[mu_i]].mu_aencMsg])) ; 
}
...
bool mu__boolexpr146;
  ...
  mu__boolexpr144 = (!(mu_Spy_known[mu_msgs[mu_pat7Set.mu_content[mu_i]].mu_aencMsg])) ; 
}
	      if (mu__boolexpr144) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr151;
  if (!((mu_i1) <= (mu_pat1Set.mu_length))) mu__boolexpr151 = FALSE ;
  else {
  mu__boolexpr151 = (mu_Spy_known[mu_pat1Set.mu_content[mu_i1]]) ; 
}
  if (!(mu__boolexpr151)) mu__boolexpr150 = FALSE ;
  else {
  mu__boolexpr150 = ((mu_i2) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr150)) mu__boolexpr149 = FALSE ;
  else {
  mu__boolexpr149 = (mu_Spy_known[mu_pat1Set.mu_content[mu_i2]]) ; 
}
  if (!(mu__boolexpr149)) mu__boolexpr148 = FALSE ;
  else {
  mu__boolexpr148 = (mu_matchPat( mu_msgs[mu_construct6By11( mu_pat1Set.mu_content[mu_i1], mu_pat1Set.mu_content[mu_i2] )], mu_sPat6Set )) ; 
}
  if (!(mu__boolexpr148)) mu__boolexpr147 = FALSE ;
  else {
  mu__boolexpr147 = (!(mu_Spy_known[mu_construct6By11( mu_pat1Set.mu_content[mu_i1], mu_pat1Set.mu_content[mu_i2] )])) ; 
}
...
bool mu__boolexpr156;
  if (!((mu_i1) <= (mu_pat1Set.mu_length))) mu__boolexpr156 = FALSE ;
  else {
  mu__boolexpr156 = (mu_Spy_known[mu_pat1Set.mu_content[mu_i1]]) ; 
}
  if (!(mu__boolexpr156)) mu__boolexpr155 = FALSE ;
  else {
  mu__boolexpr155 = ((mu_i2) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr155)) mu__boolexpr154 = FALSE ;
  else {
  mu__boolexpr154 = (mu_Spy_known[mu_pat1Set.mu_content[mu_i2]]) ; 
}
  if (!(mu__boolexpr154)) mu__boolexpr153 = FALSE ;
  else {
  mu__boolexpr153 = (mu_matchPat( mu_msgs[mu_construct6By11( mu_pat1Set.mu_content[mu_i1], mu_pat1Set.mu_content[mu_i2] )], mu_sPat6Set )) ; 
}
  if (!(mu__boolexpr153)) mu__boolexpr152 = FALSE ;
  else {
  mu__boolexpr152 = (!(mu_Spy_known[mu_construct6By11( mu_pat1Set.mu_content[mu_i1], mu_pat1Set.mu_content[mu_i2] )])) ; 
}
	      if (mu__boolexpr152) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr160;
  if (!(mu_Spy_known[mu_msgs[mu_pat6Set.mu_content[mu_i]].mu_concatPart[1]])) mu__boolexpr160 = FALSE ;
  else {
  mu__boolexpr160 = (mu_Spy_known[mu_msgs[mu_pat6Set.mu_content[mu_i]].mu_concatPart[2]]) ; 
}
...
bool mu__boolexpr163;
  if (!((mu_i) <= (mu_pat6Set.mu_length))) mu__boolexpr163 = FALSE ;
  else {
  mu__boolexpr163 = ((mu_pat6Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr163)) mu__boolexpr162 = FALSE ;
  else {
  mu__boolexpr162 = (mu_Spy_known[mu_pat6Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr162)) mu__boolexpr161 = FALSE ;
  else {
bool mu__boolexpr164;
  if (!(mu_Spy_known[mu_msgs[mu_pat6Set.mu_content[mu_i]].mu_concatPart[1]])) mu__boolexpr164 = FALSE ;
  else {
  mu__boolexpr164 = (mu_Spy_known[mu_msgs[mu_pat6Set.mu_content[mu_i]].mu_concatPart[2]]) ; 
}
...
bool mu__boolexpr178;
  if (!((mu_i) <= (mu_pat3Set.mu_length))) mu__boolexpr178 = FALSE ;
  else {
  mu__boolexpr178 = ((mu_pat3Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr178)) mu__boolexpr177 = FALSE ;
  else {
  mu__boolexpr177 = (mu_Spy_known[mu_pat3Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr177)) mu__boolexpr176 = FALSE ;
  else {
  mu__boolexpr176 = ((mu_j) <= (mu_pat4Set.mu_length)) ; 
}
  if (!(mu__boolexpr176)) mu__boolexpr175 = FALSE ;
  else {
  mu__boolexpr175 = ((mu_pat4Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr175)) mu__boolexpr174 = FALSE ;
  else {
  mu__boolexpr174 = (mu_Spy_known[mu_pat4Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr174)) mu__boolexpr173 = FALSE ;
  else {
  mu__boolexpr173 = (mu_matchPat( mu_msgs[mu_construct5By34( mu_pat3Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )], mu_sPat5Set )) ; 
}
  if (!(mu__boolexpr173)) mu__boolexpr172 = FALSE ;
  else {
  mu__boolexpr172 = (!(mu_Spy_known[mu_construct5By34( mu_pat3Set.mu_content[mu_i], mu_pat4Set.mu_content[mu_j] )])) ; 
}
	      if (mu__boolexpr172) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr181;
  if (!((mu_i) <= (mu_pat5Set.mu_length))) mu__boolexpr181 = FALSE ;
  else {
  ...
  mu__boolexpr179 = (!(mu_Spy_known[mu_msgs[mu_pat5Set.mu_content[mu_i]].mu_aencMsg])) ; 
}
...
bool mu__boolexpr184;
  ...
  mu__boolexpr182 = (!(mu_Spy_known[mu_msgs[mu_pat5Set.mu_content[mu_i]].mu_aencMsg])) ; 
}
	      if (mu__boolexpr182) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr189;
  if (!((mu_i1) <= (mu_pat1Set.mu_length))) mu__boolexpr189 = FALSE ;
  else {
  mu__boolexpr189 = (mu_Spy_known[mu_pat1Set.mu_content[mu_i1]]) ; 
}
  if (!(mu__boolexpr189)) mu__boolexpr188 = FALSE ;
  else {
  mu__boolexpr188 = ((mu_i2) <= (mu_pat2Set.mu_length)) ; 
}
  if (!(mu__boolexpr188)) mu__boolexpr187 = FALSE ;
  else {
  mu__boolexpr187 = (mu_Spy_known[mu_pat2Set.mu_content[mu_i2]]) ; 
}
  if (!(mu__boolexpr187)) mu__boolexpr186 = FALSE ;
  else {
  mu__boolexpr186 = (mu_matchPat( mu_msgs[mu_construct3By12( mu_pat1Set.mu_content[mu_i1], mu_pat2Set.mu_content[mu_i2] )], mu_sPat3Set )) ; 
}
  if (!(mu__boolexpr186)) mu__boolexpr185 = FALSE ;
  else {
  mu__boolexpr185 = (!(mu_Spy_known[mu_construct3By12( mu_pat1Set.mu_content[mu_i1], mu_pat2Set.mu_content[mu_i2] )])) ; 
}
...
bool mu__boolexpr194;
  if (!((mu_i1) <= (mu_pat1Set.mu_length))) mu__boolexpr194 = FALSE ;
  else {
  mu__boolexpr194 = (mu_Spy_known[mu_pat1Set.mu_content[mu_i1]]) ; 
}
  if (!(mu__boolexpr194)) mu__boolexpr193 = FALSE ;
  else {
  mu__boolexpr193 = ((mu_i2) <= (mu_pat2Set.mu_length)) ; 
}
  if (!(mu__boolexpr193)) mu__boolexpr192 = FALSE ;
  else {
  mu__boolexpr192 = (mu_Spy_known[mu_pat2Set.mu_content[mu_i2]]) ; 
}
  if (!(mu__boolexpr192)) mu__boolexpr191 = FALSE ;
  else {
  mu__boolexpr191 = (mu_matchPat( mu_msgs[mu_construct3By12( mu_pat1Set.mu_content[mu_i1], mu_pat2Set.mu_content[mu_i2] )], mu_sPat3Set )) ; 
}
  if (!(mu__boolexpr191)) mu__boolexpr190 = FALSE ;
  else {
  mu__boolexpr190 = (!(mu_Spy_known[mu_construct3By12( mu_pat1Set.mu_content[mu_i1], mu_pat2Set.mu_content[mu_i2] )])) ; 
}
	      if (mu__boolexpr190) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr198;
  if (!(mu_Spy_known[mu_msgs[mu_pat3Set.mu_content[mu_i]].mu_concatPart[1]])) mu__boolexpr198 = FALSE ;
  else {
  mu__boolexpr198 = (mu_Spy_known[mu_msgs[mu_pat3Set.mu_content[mu_i]].mu_concatPart[2]]) ; 
}
  mu__boolexpr195 = (!(mu__boolexpr198)) ; 
}
...
bool mu__boolexpr201;
  if (!((mu_i) <= (mu_pat3Set.mu_length))) mu__boolexpr201 = FALSE ;
  else {
  mu__boolexpr201 = ((mu_pat3Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr201)) mu__boolexpr200 = FALSE ;
  else {
  mu__boolexpr200 = (mu_Spy_known[mu_pat3Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr200)) mu__boolexpr199 = FALSE ;
  else {
bool mu__boolexpr202;
  if (!(mu_Spy_known[mu_msgs[mu_pat3Set.mu_content[mu_i]].mu_concatPart[1]])) mu__boolexpr202 = FALSE ;
  else {
  mu__boolexpr202 = (mu_Spy_known[mu_msgs[mu_pat3Set.mu_content[mu_i]].mu_concatPart[2]]) ; 
}
  mu__boolexpr199 = (!(mu__boolexpr202)) ; 
}
	      if (mu__boolexpr199) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr222;
  if (!((mu_ch[1].mu_empty) == (mu_true))) mu__boolexpr222 = FALSE ;
  else {
...
bool mu__boolexpr226;
  if (!((mu_ch[1].mu_empty) == (mu_true))) mu__boolexpr226 = FALSE ;
  else {
  mu__boolexpr226 = ((mu_i) <= (mu_pat5Set.mu_length)) ; 
}
  if (!(mu__boolexpr226)) mu__boolexpr225 = FALSE ;
  else {
  mu__boolexpr225 = ((mu_pat5Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr225)) mu__boolexpr224 = FALSE ;
  else {
  mu__boolexpr224 = (mu_Spy_known[mu_pat5Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr224)) mu__boolexpr223 = FALSE ;
  else {
  mu__boolexpr223 = (mu_matchPat( mu_msgs[mu_pat5Set.mu_content[mu_i]], mu_sPat5Set )) ; 
}
	      if (mu__boolexpr223) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr228;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B3))) mu__boolexpr228 = FALSE ;
  else {
...
bool mu__boolexpr230;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B3))) mu__boolexpr230 = FALSE ;
  else {
  mu__boolexpr230 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
...
bool mu__boolexpr231;
  if (!(mu_matchNonce( mu_roleB[mu_i].mu_locNb, mu_roleB[mu_i].mu_Nb ))) mu__boolexpr231 = FALSE ;
  else {
  mu__boolexpr231 = (mu_matchAgent( mu_roleB[mu_i].mu_locB, mu_roleB[mu_i].mu_B )) ; 
}
if ( mu__boolexpr231 )
{
mu_ch[3].mu_empty = mu_true;
...
bool mu__boolexpr233;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B2))) mu__boolexpr233 = FALSE ;
  else {
  mu__boolexpr233 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr233)) mu__boolexpr232 = FALSE ;
  else {
  mu__boolexpr232 = (!(mu_roleB[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr235;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B2))) mu__boolexpr235 = FALSE ;
  else {
  mu__boolexpr235 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr235)) mu__boolexpr234 = FALSE ;
  else {
  mu__boolexpr234 = (!(mu_roleB[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr234) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr237;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B1))) mu__boolexpr237 = FALSE ;
  else {
  mu__boolexpr237 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr237)) mu__boolexpr236 = FALSE ;
  else {
  mu__boolexpr236 = (!(mu_roleB[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr239;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B1))) mu__boolexpr239 = FALSE ;
  else {
  mu__boolexpr239 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr239)) mu__boolexpr238 = FALSE ;
  else {
  mu__boolexpr238 = (!(mu_roleB[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr238) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr241;
  if (!(mu_matchNonce( mu_roleB[mu_i].mu_locNa, mu_roleB[mu_i].mu_Na ))) mu__boolexpr241 = FALSE ;
  else {
  mu__boolexpr241 = (mu_matchAgent( mu_roleB[mu_i].mu_locA, mu_roleB[mu_i].mu_A )) ; 
}
  if (!(mu__boolexpr241)) mu__boolexpr240 = FALSE ;
  else {
  mu__boolexpr240 = (mu_matchAgent( mu_roleB[mu_i].mu_locB, mu_roleB[mu_i].mu_B )) ; 
}
if ( mu__boolexpr240 )
{
mu_ch[1].mu_empty = mu_true;
...
bool mu__boolexpr243;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A3))) mu__boolexpr243 = FALSE ;
  else {
  mu__boolexpr243 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
...
bool mu__boolexpr245;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A3))) mu__boolexpr245 = FALSE ;
  else {
  mu__boolexpr245 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
...
bool mu__boolexpr247;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A2))) mu__boolexpr247 = FALSE ;
  else {
  mu__boolexpr247 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr247)) mu__boolexpr246 = FALSE ;
  else {
  mu__boolexpr246 = (!(mu_roleA[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr249;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A2))) mu__boolexpr249 = FALSE ;
  else {
  mu__boolexpr249 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr249)) mu__boolexpr248 = FALSE ;
  else {
  mu__boolexpr248 = (!(mu_roleA[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr248) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr251;
  if (!(mu_matchNonce( mu_roleA[mu_i].mu_locNa, mu_roleA[mu_i].mu_Na ))) mu__boolexpr251 = FALSE ;
  else {
  mu__boolexpr251 = (mu_matchNonce( mu_roleA[mu_i].mu_locNb, mu_roleA[mu_i].mu_Nb )) ; 
}
  if (!(mu__boolexpr251)) mu__boolexpr250 = FALSE ;
  else {
  mu__boolexpr250 = (mu_matchAgent( mu_roleA[mu_i].mu_locA, mu_roleA[mu_i].mu_A )) ; 
}
if ( mu__boolexpr250 )
{
mu_ch[2].mu_empty = mu_true;
...
bool mu__boolexpr253;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A1))) mu__boolexpr253 = FALSE ;
  else {
  mu__boolexpr253 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr253)) mu__boolexpr252 = FALSE ;
  else {
  mu__boolexpr252 = (!(mu_roleA[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr255;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A1))) mu__boolexpr255 = FALSE ;
  else {
  mu__boolexpr255 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr255)) mu__boolexpr254 = FALSE ;
  else {
  mu__boolexpr254 = (!(mu_roleA[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr254) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_256() // Invariant "weakB"
{
bool mu__quant257; 
mu__quant257 = TRUE;
{
...
bool mu__boolexpr258;
  if (!((mu_roleA[mu_i].mu_commit) == (mu_true))) mu__boolexpr258 = TRUE ;
  else {
bool mu__quant259; 
mu__quant259 = FALSE;
{
...
bool mu__condition_260() // Condition for Rule "weakB"
{
...
int mu__invariant_261() // Invariant "secrecy"
{
bool mu__quant262; 
mu__quant262 = TRUE;
{
...
bool mu__boolexpr264;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_nonce))) mu__boolexpr264 = FALSE ;
  else {
  mu__boolexpr264 = ((mu_msgs[mu_i].mu_noncePart) == (mu_Nb)) ; 
}
  if (!(mu__boolexpr264)) mu__boolexpr263 = TRUE ;
  else {
  mu__boolexpr263 = ((mu_Spy_known[mu_i]) == (mu_false)) ; 
}
if ( !(mu__boolexpr263) )
...
bool mu__condition_265() // Condition for Rule "secrecy"
{
...
{"secrecy", &mu__condition_265, NULL, },
{"weakB", &mu__condition_260, NULL, },
};
