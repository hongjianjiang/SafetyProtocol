...
class mu_1_MsgType: public mu__byte
{
 public:
  ...
  mu_1_MsgType (const char *name, int os): mu__byte(14, 26, 4, name, os) {};
  mu_1_MsgType (void): mu__byte(14, 26, 4) {};
  mu_1_MsgType (int val): mu__byte(14, 26, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_AStatus: public mu__byte
{
 public:
  ...
  mu_1_AStatus (const char *name, int os): mu__byte(31, 33, 2, name, os) {};
  mu_1_AStatus (void): mu__byte(31, 33, 2) {};
  mu_1_AStatus (int val): mu__byte(31, 33, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_BStatus: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_BStatus::values[ int(val) - 34] );
    else return ( s << "Undefined" );
  };

  mu_1_BStatus (const char *name, int os): mu__byte(34, 36, 2, name, os) {};
  mu_1_BStatus (void): mu__byte(34, 36, 2) {};
  mu_1_BStatus (int val): mu__byte(34, 36, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
void mu_1_RoleA::set_self(const char *n, int os)
{
  ...
  if (name) mu_m1.set_self_2(name, ".m1", os + 248 ); else mu_m1.set_self_2(NULL, NULL, 0);
  if (name) mu_m3.set_self_2(name, ".m3", os + 472 ); else mu_m3.set_self_2(NULL, NULL, 0);
  if (name) mu_g.set_self_2(name, ".g", os + 696 ); else mu_g.set_self_2(NULL, NULL, 0);
  if (name) mu_p.set_self_2(name, ".p", os + 704 ); else mu_p.set_self_2(NULL, NULL, 0);
  if (name) mu_x.set_self_2(name, ".x", os + 712 ); else mu_x.set_self_2(NULL, NULL, 0);
  if (name) mu_y.set_self_2(name, ".y", os + 720 ); else mu_y.set_self_2(NULL, NULL, 0);
  if (name) mu_xi.set_self_2(name, ".xi", os + 728 ); else mu_xi.set_self_2(NULL, NULL, 0);
  if (name) mu_yi.set_self_2(name, ".yi", os + 736 ); else mu_yi.set_self_2(NULL, NULL, 0);
  if (name) mu_locNa.set_self_2(name, ".locNa", os + 744 ); else mu_locNa.set_self_2(NULL, NULL, 0);
  if (name) mu_locA.set_self_2(name, ".locA", os + 752 ); else mu_locA.set_self_2(NULL, NULL, 0);
  if (name) mu_locB.set_self_2(name, ".locB", os + 760 ); else mu_locB.set_self_2(NULL, NULL, 0);
  if (name) mu_locm2.set_self_2(name, ".locm2", os + 768 ); else mu_locm2.set_self_2(NULL, NULL, 0);
  if (name) mu_locm1.set_self_2(name, ".locm1", os + 992 ); else mu_locm1.set_self_2(NULL, NULL, 0);
  if (name) mu_locm3.set_self_2(name, ".locm3", os + 1216 ); else mu_locm3.set_self_2(NULL, NULL, 0);
  if (name) mu_locg.set_self_2(name, ".locg", os + 1440 ); else mu_locg.set_self_2(NULL, NULL, 0);
  if (name) mu_locp.set_self_2(name, ".locp", os + 1448 ); else mu_locp.set_self_2(NULL, NULL, 0);
  if (name) mu_locx.set_self_2(name, ".locx", os + 1456 ); else mu_locx.set_self_2(NULL, NULL, 0);
  if (name) mu_locy.set_self_2(name, ".locy", os + 1464 ); else mu_locy.set_self_2(NULL, NULL, 0);
  if (name) mu_locxi.set_self_2(name, ".locxi", os + 1472 ); else mu_locxi.set_self_2(NULL, NULL, 0);
  if (name) mu_locyi.set_self_2(name, ".locyi", os + 1480 ); else mu_locyi.set_self_2(NULL, NULL, 0);
  if (name) mu_st.set_self_2(name, ".st", os + 1488 ); else mu_st.set_self_2(NULL, NULL, 0);
  if (name) mu_commit.set_self_2(name, ".commit", os + 1496 ); else mu_commit.set_self_2(NULL, NULL, 0);
}
...
void mu_1__type_3::set_self( const char *n, int os)
{
  ...
  name = (char *)n;
  for(int i = 0; i < 1; i++) {
    array[i].set_self_ar(n, s=tsprintf("%d",i + 1), i * 1504 + os);
    delete[] s;
  }
};
...
/*** Variable declaration ***/
mu_1__type_4 mu_roleB("roleB",6216);

/*** Variable declaration ***/
mu_1__type_5 mu_msgs("msgs",7720);

/*** Variable declaration ***/
mu_1_indexType mu_msg_end("msg_end",30344);

/*** Variable declaration ***/
mu_1_msgSet mu_pat1Set("pat1Set",30352);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat1Set("sPat1Set",31168);

/*** Variable declaration ***/
mu_1_msgSet mu_pat2Set("pat2Set",31984);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat2Set("sPat2Set",32800);

/*** Variable declaration ***/
mu_1_msgSet mu_pat3Set("pat3Set",33616);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat3Set("sPat3Set",34432);

/*** Variable declaration ***/
mu_1_msgSet mu_pat4Set("pat4Set",35248);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat4Set("sPat4Set",36064);

/*** Variable declaration ***/
mu_1_msgSet mu_pat5Set("pat5Set",36880);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat5Set("sPat5Set",37696);

/*** Variable declaration ***/
mu_1_msgSet mu_pat6Set("pat6Set",38512);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat6Set("sPat6Set",39328);

/*** Variable declaration ***/
mu_1_msgSet mu_pat7Set("pat7Set",40144);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat7Set("sPat7Set",40960);

/*** Variable declaration ***/
mu_1_msgSet mu_pat8Set("pat8Set",41776);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat8Set("sPat8Set",42592);

/*** Variable declaration ***/
mu_1_msgSet mu_pat9Set("pat9Set",43408);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat9Set("sPat9Set",44224);

/*** Variable declaration ***/
mu_1_msgSet mu_pat10Set("pat10Set",45040);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat10Set("sPat10Set",45856);

/*** Variable declaration ***/
mu_1_msgSet mu_pat11Set("pat11Set",46672);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat11Set("sPat11Set",47488);

/*** Variable declaration ***/
mu_1_msgSet mu_pat12Set("pat12Set",48304);

/*** Variable declaration ***/
mu_1_msgSet mu_sPat12Set("sPat12Set",49120);

/*** Variable declaration ***/
mu_1__type_6 mu_A_known("A_known",49936);

/*** Variable declaration ***/
mu_1__type_7 mu_B_known("B_known",50744);

/*** Variable declaration ***/
mu_1__type_8 mu_Spy_known("Spy_known",51552);

/*** Variable declaration ***/
mu_0_boolean mu_IntruEmit1("IntruEmit1",52360);

/*** Variable declaration ***/
mu_0_boolean mu_IntruEmit2("IntruEmit2",52368);

/*** Variable declaration ***/
mu_0_boolean mu_IntruEmit3("IntruEmit3",52376);

/*** Variable declaration ***/
mu_1__type_9 mu_emit("emit",52384);

/*** Variable declaration ***/
mu_1_indexType mu_gnum("gnum",53192);
...
{
bool mu__boolexpr51;
  if (!((mu_msgs[mu_i].mu_expMsg1) == (mu_msgNo11))) mu__boolexpr51 = FALSE ;
  else {
  mu__boolexpr51 = ((mu_msgs[mu_i].mu_expMsg2) == (mu_msgNo12)) ; 
}
if ( mu__boolexpr51 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr52;
  if (!((mu_msgs[mu_i].mu_expMsg1) == (mu_msgNo11))) mu__boolexpr52 = FALSE ;
  else {
  mu__boolexpr52 = ((mu_msgs[mu_i].mu_expMsg2) == (mu_msgNo12)) ; 
}
if ( mu__boolexpr52 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr53;
  if (!((mu_msgs[mu_i].mu_modMsg1) == (mu_msgNo21))) mu__boolexpr53 = FALSE ;
  else {
  mu__boolexpr53 = ((mu_msgs[mu_i].mu_modMsg2) == (mu_msgNo12)) ; 
}
if ( mu__boolexpr53 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr54;
  if (!((mu_msgs[mu_i].mu_modMsg1) == (mu_msgNo21))) mu__boolexpr54 = FALSE ;
  else {
  mu__boolexpr54 = ((mu_msgs[mu_i].mu_modMsg2) == (mu_msgNo12)) ; 
}
if ( mu__boolexpr54 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr55;
  if (!((mu_msgs[mu_i].mu_expMsg1) == (mu_msgNo41))) mu__boolexpr55 = FALSE ;
  else {
  mu__boolexpr55 = ((mu_msgs[mu_i].mu_expMsg2) == (mu_msgNo12)) ; 
}
if ( mu__boolexpr55 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr56;
  if (!((mu_msgs[mu_i].mu_expMsg1) == (mu_msgNo41))) mu__boolexpr56 = FALSE ;
  else {
  mu__boolexpr56 = ((mu_msgs[mu_i].mu_expMsg2) == (mu_msgNo12)) ; 
}
if ( mu__boolexpr56 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr57;
  if (!((mu_msgs[mu_i].mu_modMsg1) == (mu_msgNo61))) mu__boolexpr57 = FALSE ;
  else {
  mu__boolexpr57 = ((mu_msgs[mu_i].mu_modMsg2) == (mu_msgNo12)) ; 
}
if ( mu__boolexpr57 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr58;
  if (!((mu_msgs[mu_i].mu_modMsg1) == (mu_msgNo61))) mu__boolexpr58 = FALSE ;
  else {
  mu__boolexpr58 = ((mu_msgs[mu_i].mu_modMsg2) == (mu_msgNo12)) ; 
}
if ( mu__boolexpr58 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr59;
  if (!((mu_msgs[mu_i].mu_sencMsg) == (mu_msgNo51))) mu__boolexpr59 = FALSE ;
  else {
  mu__boolexpr59 = ((mu_msgs[mu_i].mu_sencKey) == (mu_msgNo72)) ; 
}
if ( mu__boolexpr59 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr60;
  if (!((mu_msgs[mu_i].mu_sencMsg) == (mu_msgNo51))) mu__boolexpr60 = FALSE ;
  else {
  mu__boolexpr60 = ((mu_msgs[mu_i].mu_sencKey) == (mu_msgNo72)) ; 
}
if ( mu__boolexpr60 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr61;
  if (!((mu_msgs[mu_i].mu_sencMsg) == (mu_msgNo101))) mu__boolexpr61 = FALSE ;
  else {
  mu__boolexpr61 = ((mu_msgs[mu_i].mu_sencKey) == (mu_msgNo72)) ; 
}
if ( mu__boolexpr61 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr62;
  if (!((mu_msgs[mu_i].mu_sencMsg) == (mu_msgNo101))) mu__boolexpr62 = FALSE ;
  else {
  mu__boolexpr62 = ((mu_msgs[mu_i].mu_sencKey) == (mu_msgNo72)) ; 
}
if ( mu__boolexpr62 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr65;
  if (!((mu_msgs[mu_i].mu_expMsg1) == (mu_i1))) mu__boolexpr65 = FALSE ;
  else {
  mu__boolexpr65 = ((mu_msgs[mu_i].mu_expMsg2) == (mu_i2)) ; 
}
if ( mu__boolexpr65 )
{
mu_index = mu_i;
...
bool mu__boolexpr66;
  if (!(mu_flagPart1)) mu__boolexpr66 = FALSE ;
  else {
  mu__boolexpr66 = (mu_flagPart2) ; 
}
if ( mu__boolexpr66 )
{
mu_flag1 = mu_true;
...
{
bool mu__boolexpr69;
  if (!((mu_msgs[mu_i].mu_expMsg1) == (mu_i1))) mu__boolexpr69 = FALSE ;
  else {
  mu__boolexpr69 = ((mu_msgs[mu_i].mu_expMsg2) == (mu_i2)) ; 
}
if ( mu__boolexpr69 )
{
if (mu_i.isundefined())
...
{
bool mu__boolexpr70;
  if (!((mu_msgs[mu_i].mu_modMsg1) == (mu_i1))) mu__boolexpr70 = FALSE ;
  else {
  mu__boolexpr70 = ((mu_msgs[mu_i].mu_modMsg2) == (mu_i2)) ; 
}
if ( mu__boolexpr70 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr74;
  if (!((mu_msgs[mu_i].mu_modMsg1) == (mu_i1))) mu__boolexpr74 = FALSE ;
  else {
  mu__boolexpr74 = ((mu_msgs[mu_i].mu_modMsg2) == (mu_i2)) ; 
}
if ( mu__boolexpr74 )
{
if (mu_i.isundefined())
...
mu_i = 1;
{
  bool mu__while_expr_78;  mu__while_expr_78 = (mu_i) <= (mu_msg_end);
...
mu__while_expr_78 = (mu_i) <= (mu_msg_end);
}
};
if ( (mu_index) == (0) )
{
...
{
bool mu__boolexpr79;
  if (!((mu_msgs[mu_i].mu_expMsg1) == (mu_i1))) mu__boolexpr79 = FALSE ;
  else {
  mu__boolexpr79 = ((mu_msgs[mu_i].mu_expMsg2) == (mu_i2)) ; 
}
if ( mu__boolexpr79 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr83;
  if (!((mu_msgs[mu_i].mu_expMsg1) == (mu_i1))) mu__boolexpr83 = FALSE ;
  else {
  mu__boolexpr83 = ((mu_msgs[mu_i].mu_expMsg2) == (mu_i2)) ; 
}
if ( mu__boolexpr83 )
{
if (mu_i.isundefined())
...
{
bool mu__boolexpr84;
  if (!((mu_msgs[mu_i].mu_modMsg1) == (mu_i1))) mu__boolexpr84 = FALSE ;
  else {
  mu__boolexpr84 = ((mu_msgs[mu_i].mu_modMsg2) == (mu_i2)) ; 
}
if ( mu__boolexpr84 )
{
mu_index = mu_i;
...
mu_isPat1 ( mu_msgs[mu_msg.mu_modMsg2], mu_flagPart2 );
bool mu__boolexpr85;
  if (!(mu_flagPart1)) mu__boolexpr85 = FALSE ;
  else {
  mu__boolexpr85 = (mu_flagPart2) ; 
}
if ( mu__boolexpr85 )
{
mu_flag1 = mu_true;
...
{
bool mu__boolexpr88;
  if (!((mu_msgs[mu_i].mu_modMsg1) == (mu_i1))) mu__boolexpr88 = FALSE ;
  else {
  mu__boolexpr88 = ((mu_msgs[mu_i].mu_modMsg2) == (mu_i2)) ; 
}
if ( mu__boolexpr88 )
{
if (mu_i.isundefined())
...
{
bool mu__boolexpr89;
  if (!((mu_msgs[mu_i].mu_sencMsg) == (mu_i1))) mu__boolexpr89 = FALSE ;
  else {
  mu__boolexpr89 = ((mu_msgs[mu_i].mu_sencKey) == (mu_i2)) ; 
}
if ( mu__boolexpr89 )
{
mu_index = mu_i;
...
{
bool mu__boolexpr98;
  if (!((mu_msgs[mu_i].mu_sencMsg) == (mu_i1))) mu__boolexpr98 = FALSE ;
  else {
  mu__boolexpr98 = ((mu_msgs[mu_i].mu_sencKey) == (mu_i2)) ; 
}
if ( mu__boolexpr98 )
{
mu_index = mu_i;
...
bool mu__boolexpr102;
  if (!((mu_msgs[mu_i].mu_sencMsg) == (mu_i1))) mu__boolexpr102 = FALSE ;
  else {
  mu__boolexpr102 = ((mu_msgs[mu_i].mu_sencKey) == (mu_i2)) ; 
}
if ( mu__boolexpr102 )
{
if (mu_i.isundefined())
...
/*** Variable declaration ***/
mu_1_Message mu_modMsg2("modMsg2",240);
...
/*** Variable declaration ***/
mu_1_Message mu_sencMsg("sencMsg",224);
...
bool mu__boolexpr134;
  if (!((mu_i) <= (mu_pat10Set.mu_length))) mu__boolexpr134 = FALSE ;
  else {
  mu__boolexpr134 = ((mu_pat10Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr134)) mu__boolexpr133 = FALSE ;
  else {
  mu__boolexpr133 = (mu_Spy_known[mu_pat10Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr133)) mu__boolexpr132 = FALSE ;
  else {
  mu__boolexpr132 = ((mu_j) <= (mu_pat7Set.mu_length)) ; 
}
  if (!(mu__boolexpr132)) mu__boolexpr131 = FALSE ;
  else {
  mu__boolexpr131 = ((mu_pat7Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr131)) mu__boolexpr130 = FALSE ;
  else {
  mu__boolexpr130 = (mu_Spy_known[mu_pat7Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr130)) mu__boolexpr129 = FALSE ;
  else {
  mu__boolexpr129 = (mu_matchPat( mu_construct11By107( mu_pat10Set.mu_content[mu_i], mu_pat7Set.mu_content[mu_j] ), mu_sPat11Set )) ; 
}
  if (!(mu__boolexpr129)) mu__boolexpr128 = FALSE ;
  else {
  mu__boolexpr128 = (!(mu_Spy_known[mu_constructIndex11By107( mu_pat10Set.mu_content[mu_i], mu_pat7Set.mu_content[mu_j] )])) ; 
}
...
bool mu__boolexpr141;
  if (!((mu_i) <= (mu_pat10Set.mu_length))) mu__boolexpr141 = FALSE ;
  else {
  mu__boolexpr141 = ((mu_pat10Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr141)) mu__boolexpr140 = FALSE ;
  else {
  mu__boolexpr140 = (mu_Spy_known[mu_pat10Set.mu_content[mu_i]]) ; 
}
  ...
  mu__boolexpr136 = (mu_matchPat( mu_construct11By107( mu_pat10Set.mu_content[mu_i], mu_pat7Set.mu_content[mu_j] ), mu_sPat11Set )) ; 
}
  if (!(mu__boolexpr136)) mu__boolexpr135 = FALSE ;
  else {
  mu__boolexpr135 = (!(mu_Spy_known[mu_constructIndex11By107( mu_pat10Set.mu_content[mu_i], mu_pat7Set.mu_content[mu_j] )])) ; 
}
	      if (mu__boolexpr135) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr144;
  if (!((mu_i) <= (mu_pat11Set.mu_length))) mu__boolexpr144 = FALSE ;
  else {
  mu__boolexpr144 = ((mu_pat11Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr144)) mu__boolexpr143 = FALSE ;
  else {
  mu__boolexpr143 = (mu_Spy_known[mu_pat11Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr143)) mu__boolexpr142 = FALSE ;
  else {
  mu__boolexpr142 = (!(mu_Spy_known[mu_msgs[mu_pat11Set.mu_content[mu_i]].mu_sencMsg])) ; 
}
...
bool mu__boolexpr147;
  if (!((mu_i) <= (mu_pat11Set.mu_length))) mu__boolexpr147 = FALSE ;
  else {
  mu__boolexpr147 = ((mu_pat11Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr147)) mu__boolexpr146 = FALSE ;
  else {
  mu__boolexpr146 = (mu_Spy_known[mu_pat11Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr146)) mu__boolexpr145 = FALSE ;
  else {
  mu__boolexpr145 = (!(mu_Spy_known[mu_msgs[mu_pat11Set.mu_content[mu_i]].mu_sencMsg])) ; 
}
	      if (mu__boolexpr145) {
		if ( ( TRUE  ) )
		  return;
...
/*** Variable declaration ***/
mu_1_indexType mu_msgPat10("msgPat10",224);

/*** Variable declaration ***/
mu_1_indexType mu_keyNo("keyNo",232);

/*** Variable declaration ***/
mu_0_boolean mu_flag_pat10("flag_pat10",240);
...
bool mu__boolexpr148;
  if (!((mu_key_inv.mu_k.mu_encType) == (mu_MsgK))) mu__boolexpr148 = FALSE ;
  else {
  mu__boolexpr148 = (mu_Spy_known[mu_keyNo]) ; 
}
if ( mu__boolexpr148 )
{
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_i.value((r % 6) + 0);
    r = r / 6;
    return tsprintf("sencrypt 8, i1:%s, j:%s, i:%s", mu_i1.Name(), mu_j.Name(), mu_i.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_roleBNums mu_i1;
...
bool mu__boolexpr156;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B3))) mu__boolexpr156 = FALSE ;
  else {
  mu__boolexpr156 = ((mu_i) <= (mu_pat5Set.mu_length)) ; 
}
  if (!(mu__boolexpr156)) mu__boolexpr155 = FALSE ;
  else {
  mu__boolexpr155 = ((mu_pat5Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr155)) mu__boolexpr154 = FALSE ;
  else {
  mu__boolexpr154 = (mu_Spy_known[mu_pat5Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr154)) mu__boolexpr153 = FALSE ;
  else {
  mu__boolexpr153 = ((mu_j) <= (mu_pat7Set.mu_length)) ; 
}
  if (!(mu__boolexpr153)) mu__boolexpr152 = FALSE ;
  else {
  mu__boolexpr152 = ((mu_pat7Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr152)) mu__boolexpr151 = FALSE ;
  else {
  mu__boolexpr151 = (mu_Spy_known[mu_pat7Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr151)) mu__boolexpr150 = FALSE ;
  else {
  mu__boolexpr150 = (mu_matchPat( mu_construct8By57( mu_pat5Set.mu_content[mu_i], mu_pat7Set.mu_content[mu_j] ), mu_sPat8Set )) ; 
}
  if (!(mu__boolexpr150)) mu__boolexpr149 = FALSE ;
  else {
  mu__boolexpr149 = (!(mu_Spy_known[mu_constructIndex8By57( mu_pat5Set.mu_content[mu_i], mu_pat7Set.mu_content[mu_j] )])) ; 
}
...
bool mu__boolexpr164;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B3))) mu__boolexpr164 = FALSE ;
  else {
  mu__boolexpr164 = ((mu_i) <= (mu_pat5Set.mu_length)) ; 
}
  ...
  mu__boolexpr161 = ((mu_j) <= (mu_pat7Set.mu_length)) ; 
}
  if (!(mu__boolexpr161)) mu__boolexpr160 = FALSE ;
  else {
  mu__boolexpr160 = ((mu_pat7Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr160)) mu__boolexpr159 = FALSE ;
  else {
  mu__boolexpr159 = (mu_Spy_known[mu_pat7Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr159)) mu__boolexpr158 = FALSE ;
  else {
  mu__boolexpr158 = (mu_matchPat( mu_construct8By57( mu_pat5Set.mu_content[mu_i], mu_pat7Set.mu_content[mu_j] ), mu_sPat8Set )) ; 
}
  if (!(mu__boolexpr158)) mu__boolexpr157 = FALSE ;
  else {
  mu__boolexpr157 = (!(mu_Spy_known[mu_constructIndex8By57( mu_pat5Set.mu_content[mu_i], mu_pat7Set.mu_content[mu_j] )])) ; 
}
	      if (mu__boolexpr157) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr167;
  if (!((mu_i) <= (mu_pat8Set.mu_length))) mu__boolexpr167 = FALSE ;
  else {
  mu__boolexpr167 = ((mu_pat8Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr167)) mu__boolexpr166 = FALSE ;
  else {
  mu__boolexpr166 = (mu_Spy_known[mu_pat8Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr166)) mu__boolexpr165 = FALSE ;
  else {
  mu__boolexpr165 = (!(mu_Spy_known[mu_msgs[mu_pat8Set.mu_content[mu_i]].mu_sencMsg])) ; 
}
...
bool mu__boolexpr170;
  if (!((mu_i) <= (mu_pat8Set.mu_length))) mu__boolexpr170 = FALSE ;
  else {
  mu__boolexpr170 = ((mu_pat8Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr170)) mu__boolexpr169 = FALSE ;
  else {
  mu__boolexpr169 = (mu_Spy_known[mu_pat8Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr169)) mu__boolexpr168 = FALSE ;
  else {
  mu__boolexpr168 = (!(mu_Spy_known[mu_msgs[mu_pat8Set.mu_content[mu_i]].mu_sencMsg])) ; 
}
	      if (mu__boolexpr168) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr171;
  if (!((mu_key_inv.mu_k.mu_encType) == (mu_MsgK))) mu__boolexpr171 = FALSE ;
  else {
  mu__boolexpr171 = (mu_Spy_known[mu_keyNo]) ; 
}
if ( mu__boolexpr171 )
{
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_i.value((r % 6) + 0);
    r = r / 6;
    return tsprintf("constructMod 7, i1:%s, j:%s, i:%s", mu_i1.Name(), mu_j.Name(), mu_i.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_roleBNums mu_i1;
...
bool mu__boolexpr179;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B3))) mu__boolexpr179 = FALSE ;
  else {
  mu__boolexpr179 = ((mu_i) <= (mu_pat6Set.mu_length)) ; 
}
  if (!(mu__boolexpr179)) mu__boolexpr178 = FALSE ;
  else {
  mu__boolexpr178 = ((mu_pat6Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr178)) mu__boolexpr177 = FALSE ;
  else {
  mu__boolexpr177 = (mu_Spy_known[mu_pat6Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr177)) mu__boolexpr176 = FALSE ;
  else {
  mu__boolexpr176 = ((mu_j) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr176)) mu__boolexpr175 = FALSE ;
  else {
  mu__boolexpr175 = ((mu_pat1Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr175)) mu__boolexpr174 = FALSE ;
  else {
  mu__boolexpr174 = (mu_Spy_known[mu_pat1Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr174)) mu__boolexpr173 = FALSE ;
  else {
  mu__boolexpr173 = (mu_matchPat( mu_construct7By61( mu_pat6Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] ), mu_sPat7Set )) ; 
}
  if (!(mu__boolexpr173)) mu__boolexpr172 = FALSE ;
  else {
  mu__boolexpr172 = (!(mu_Spy_known[mu_constructIndex7By61( mu_pat6Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] )])) ; 
}
...
bool mu__boolexpr187;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B3))) mu__boolexpr187 = FALSE ;
  else {
  mu__boolexpr187 = ((mu_i) <= (mu_pat6Set.mu_length)) ; 
}
  if (!(mu__boolexpr187)) mu__boolexpr186 = FALSE ;
  else {
  mu__boolexpr186 = ((mu_pat6Set.mu_content[mu_i]) != (0)) ; 
}
  ...
  mu__boolexpr184 = ((mu_j) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr184)) mu__boolexpr183 = FALSE ;
  else {
  mu__boolexpr183 = ((mu_pat1Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr183)) mu__boolexpr182 = FALSE ;
  else {
  mu__boolexpr182 = (mu_Spy_known[mu_pat1Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr182)) mu__boolexpr181 = FALSE ;
  else {
  mu__boolexpr181 = (mu_matchPat( mu_construct7By61( mu_pat6Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] ), mu_sPat7Set )) ; 
}
  if (!(mu__boolexpr181)) mu__boolexpr180 = FALSE ;
  else {
  mu__boolexpr180 = (!(mu_Spy_known[mu_constructIndex7By61( mu_pat6Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] )])) ; 
}
	      if (mu__boolexpr180) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr190;
  if (!((mu_i) <= (mu_pat7Set.mu_length))) mu__boolexpr190 = FALSE ;
  else {
...
bool mu__boolexpr191;
  if (!(mu_Spy_known[mu_msgs[mu_pat7Set.mu_content[mu_i]].mu_modMsg1])) mu__boolexpr191 = TRUE ;
  else {
  mu__boolexpr191 = (!(mu_Spy_known[mu_msgs[mu_pat7Set.mu_content[mu_i]].mu_modMsg2])) ; 
}
...
bool mu__boolexpr194;
  if (!((mu_i) <= (mu_pat7Set.mu_length))) mu__boolexpr194 = FALSE ;
  else {
...
bool mu__boolexpr195;
  if (!(mu_Spy_known[mu_msgs[mu_pat7Set.mu_content[mu_i]].mu_modMsg1])) mu__boolexpr195 = TRUE ;
  else {
  mu__boolexpr195 = (!(mu_Spy_known[mu_msgs[mu_pat7Set.mu_content[mu_i]].mu_modMsg2])) ; 
}
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_i.value((r % 6) + 0);
    r = r / 6;
    return tsprintf("constructExp 6, i1:%s, j:%s, i:%s", mu_i1.Name(), mu_j.Name(), mu_i.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_roleBNums mu_i1;
...
bool mu__boolexpr203;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B3))) mu__boolexpr203 = FALSE ;
  else {
  mu__boolexpr203 = ((mu_i) <= (mu_pat4Set.mu_length)) ; 
}
  if (!(mu__boolexpr203)) mu__boolexpr202 = FALSE ;
  else {
  mu__boolexpr202 = ((mu_pat4Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr202)) mu__boolexpr201 = FALSE ;
  else {
  mu__boolexpr201 = (mu_Spy_known[mu_pat4Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr201)) mu__boolexpr200 = FALSE ;
  else {
  mu__boolexpr200 = ((mu_j) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr200)) mu__boolexpr199 = FALSE ;
  else {
  mu__boolexpr199 = ((mu_pat1Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr199)) mu__boolexpr198 = FALSE ;
  else {
  mu__boolexpr198 = (mu_Spy_known[mu_pat1Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr198)) mu__boolexpr197 = FALSE ;
  else {
  mu__boolexpr197 = (mu_matchPat( mu_construct6By41( mu_pat4Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] ), mu_sPat6Set )) ; 
}
  if (!(mu__boolexpr197)) mu__boolexpr196 = FALSE ;
  else {
  mu__boolexpr196 = (!(mu_Spy_known[mu_constructIndex6By41( mu_pat4Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] )])) ; 
}
...
bool mu__boolexpr211;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B3))) mu__boolexpr211 = FALSE ;
  else {
  mu__boolexpr211 = ((mu_i) <= (mu_pat4Set.mu_length)) ; 
}
  if (!(mu__boolexpr211)) mu__boolexpr210 = FALSE ;
  else {
  mu__boolexpr210 = ((mu_pat4Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr210)) mu__boolexpr209 = FALSE ;
  else {
  mu__boolexpr209 = (mu_Spy_known[mu_pat4Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr209)) mu__boolexpr208 = FALSE ;
  else {
  mu__boolexpr208 = ((mu_j) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr208)) mu__boolexpr207 = FALSE ;
  else {
  mu__boolexpr207 = ((mu_pat1Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr207)) mu__boolexpr206 = FALSE ;
  else {
  mu__boolexpr206 = (mu_Spy_known[mu_pat1Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr206)) mu__boolexpr205 = FALSE ;
  else {
  mu__boolexpr205 = (mu_matchPat( mu_construct6By41( mu_pat4Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] ), mu_sPat6Set )) ; 
}
  if (!(mu__boolexpr205)) mu__boolexpr204 = FALSE ;
  else {
  mu__boolexpr204 = (!(mu_Spy_known[mu_constructIndex6By41( mu_pat4Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] )])) ; 
}
	      if (mu__boolexpr204) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr219;
  if (!((mu_i) <= (mu_pat6Set.mu_length))) mu__boolexpr219 = FALSE ;
  else {
  mu__boolexpr219 = ((mu_pat6Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr219)) mu__boolexpr218 = FALSE ;
  else {
  mu__boolexpr218 = (mu_Spy_known[mu_pat6Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr218)) mu__boolexpr217 = FALSE ;
  else {
  mu__boolexpr217 = (mu_Spy_known[mu_msgs[mu_pat6Set.mu_content[mu_i]].mu_expMsg1]) ; 
}
  if (!(mu__boolexpr217)) mu__boolexpr216 = FALSE ;
  else {
  mu__boolexpr216 = (!(mu_Spy_known[mu_msgs[mu_pat6Set.mu_content[mu_i]].mu_expMsg2])) ; 
}
	      if (mu__boolexpr216) {
		if ( ( TRUE  ) )
		  return;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_i.value((r % 6) + 0);
    r = r / 6;
    return tsprintf("constructMod 3, i1:%s, j:%s, i:%s", mu_i1.Name(), mu_j.Name(), mu_i.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_roleBNums mu_i1;
...
bool mu__boolexpr227;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B1))) mu__boolexpr227 = FALSE ;
  else {
  mu__boolexpr227 = ((mu_i) <= (mu_pat2Set.mu_length)) ; 
}
  if (!(mu__boolexpr227)) mu__boolexpr226 = FALSE ;
  else {
  mu__boolexpr226 = ((mu_pat2Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr226)) mu__boolexpr225 = FALSE ;
  else {
  mu__boolexpr225 = (mu_Spy_known[mu_pat2Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr225)) mu__boolexpr224 = FALSE ;
  else {
  mu__boolexpr224 = ((mu_j) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr224)) mu__boolexpr223 = FALSE ;
  else {
  mu__boolexpr223 = ((mu_pat1Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr223)) mu__boolexpr222 = FALSE ;
  else {
  mu__boolexpr222 = (mu_Spy_known[mu_pat1Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr222)) mu__boolexpr221 = FALSE ;
  else {
  mu__boolexpr221 = (mu_matchPat( mu_construct3By21( mu_pat2Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] ), mu_sPat3Set )) ; 
}
  if (!(mu__boolexpr221)) mu__boolexpr220 = FALSE ;
  else {
  mu__boolexpr220 = (!(mu_Spy_known[mu_constructIndex3By21( mu_pat2Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] )])) ; 
}
...
bool mu__boolexpr235;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B1))) mu__boolexpr235 = FALSE ;
  else {
  mu__boolexpr235 = ((mu_i) <= (mu_pat2Set.mu_length)) ; 
}
  if (!(mu__boolexpr235)) mu__boolexpr234 = FALSE ;
  else {
  mu__boolexpr234 = ((mu_pat2Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr234)) mu__boolexpr233 = FALSE ;
  else {
  mu__boolexpr233 = (mu_Spy_known[mu_pat2Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr233)) mu__boolexpr232 = FALSE ;
  else {
  mu__boolexpr232 = ((mu_j) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr232)) mu__boolexpr231 = FALSE ;
  else {
  mu__boolexpr231 = ((mu_pat1Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr231)) mu__boolexpr230 = FALSE ;
  else {
  mu__boolexpr230 = (mu_Spy_known[mu_pat1Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr230)) mu__boolexpr229 = FALSE ;
  else {
  mu__boolexpr229 = (mu_matchPat( mu_construct3By21( mu_pat2Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] ), mu_sPat3Set )) ; 
}
  if (!(mu__boolexpr229)) mu__boolexpr228 = FALSE ;
  else {
  mu__boolexpr228 = (!(mu_Spy_known[mu_constructIndex3By21( mu_pat2Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] )])) ; 
}
	      if (mu__boolexpr228) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr242;
  if (!((mu_i) <= (mu_pat3Set.mu_length))) mu__boolexpr242 = FALSE ;
  else {
  mu__boolexpr242 = ((mu_pat3Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr242)) mu__boolexpr241 = FALSE ;
  else {
  mu__boolexpr241 = (mu_Spy_known[mu_pat3Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr241)) mu__boolexpr240 = FALSE ;
  else {
bool mu__boolexpr243;
  if (!(mu_Spy_known[mu_msgs[mu_pat3Set.mu_content[mu_i]].mu_modMsg1])) mu__boolexpr243 = TRUE ;
  else {
  mu__boolexpr243 = (!(mu_Spy_known[mu_msgs[mu_pat3Set.mu_content[mu_i]].mu_modMsg2])) ; 
}
  mu__boolexpr240 = (mu__boolexpr243) ; 
}
	      if (mu__boolexpr240) {
		if ( ( TRUE  ) )
		  return;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_i.value((r % 6) + 0);
    r = r / 6;
    return tsprintf("constructExp 2, i1:%s, j:%s, i:%s", mu_i1.Name(), mu_j.Name(), mu_i.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_roleBNums mu_i1;
...
bool mu__boolexpr251;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B1))) mu__boolexpr251 = FALSE ;
  else {
  mu__boolexpr251 = ((mu_i) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr251)) mu__boolexpr250 = FALSE ;
  else {
  mu__boolexpr250 = ((mu_pat1Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr250)) mu__boolexpr249 = FALSE ;
  else {
  mu__boolexpr249 = (mu_Spy_known[mu_pat1Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr249)) mu__boolexpr248 = FALSE ;
  else {
  mu__boolexpr248 = ((mu_j) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr248)) mu__boolexpr247 = FALSE ;
  else {
  mu__boolexpr247 = ((mu_pat1Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr247)) mu__boolexpr246 = FALSE ;
  else {
  mu__boolexpr246 = (mu_Spy_known[mu_pat1Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr246)) mu__boolexpr245 = FALSE ;
  else {
  mu__boolexpr245 = (mu_matchPat( mu_construct2By11( mu_pat1Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] ), mu_sPat2Set )) ; 
}
  if (!(mu__boolexpr245)) mu__boolexpr244 = FALSE ;
  else {
  mu__boolexpr244 = (!(mu_Spy_known[mu_constructIndex2By11( mu_pat1Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] )])) ; 
}
...
bool mu__boolexpr259;
  if (!((mu_roleB[mu_i1].mu_st) == (mu_B1))) mu__boolexpr259 = FALSE ;
  else {
  mu__boolexpr259 = ((mu_i) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr259)) mu__boolexpr258 = FALSE ;
  else {
  mu__boolexpr258 = ((mu_pat1Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr258)) mu__boolexpr257 = FALSE ;
  else {
  mu__boolexpr257 = (mu_Spy_known[mu_pat1Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr257)) mu__boolexpr256 = FALSE ;
  else {
  mu__boolexpr256 = ((mu_j) <= (mu_pat1Set.mu_length)) ; 
}
  if (!(mu__boolexpr256)) mu__boolexpr255 = FALSE ;
  else {
  mu__boolexpr255 = ((mu_pat1Set.mu_content[mu_j]) != (0)) ; 
}
  if (!(mu__boolexpr255)) mu__boolexpr254 = FALSE ;
  else {
  mu__boolexpr254 = (mu_Spy_known[mu_pat1Set.mu_content[mu_j]]) ; 
}
  if (!(mu__boolexpr254)) mu__boolexpr253 = FALSE ;
  else {
  mu__boolexpr253 = (mu_matchPat( mu_construct2By11( mu_pat1Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] ), mu_sPat2Set )) ; 
}
  if (!(mu__boolexpr253)) mu__boolexpr252 = FALSE ;
  else {
  mu__boolexpr252 = (!(mu_Spy_known[mu_constructIndex2By11( mu_pat1Set.mu_content[mu_i], mu_pat1Set.mu_content[mu_j] )])) ; 
}
	      if (mu__boolexpr252) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr263;
  if (!((mu_i) <= (mu_pat2Set.mu_length))) mu__boolexpr263 = FALSE ;
  else {
  mu__boolexpr263 = ((mu_pat2Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr263)) mu__boolexpr262 = FALSE ;
  else {
  mu__boolexpr262 = (mu_Spy_known[mu_pat2Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr262)) mu__boolexpr261 = FALSE ;
  else {
  mu__boolexpr261 = (mu_Spy_known[mu_msgs[mu_pat2Set.mu_content[mu_i]].mu_expMsg1]) ; 
}
  if (!(mu__boolexpr261)) mu__boolexpr260 = FALSE ;
  else {
  mu__boolexpr260 = (!(mu_Spy_known[mu_msgs[mu_pat2Set.mu_content[mu_i]].mu_expMsg2])) ; 
}
...
bool mu__boolexpr267;
  if (!((mu_i) <= (mu_pat2Set.mu_length))) mu__boolexpr267 = FALSE ;
  else {
  mu__boolexpr267 = ((mu_pat2Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr267)) mu__boolexpr266 = FALSE ;
  else {
  mu__boolexpr266 = (mu_Spy_known[mu_pat2Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr266)) mu__boolexpr265 = FALSE ;
  else {
  mu__boolexpr265 = (mu_Spy_known[mu_msgs[mu_pat2Set.mu_content[mu_i]].mu_expMsg1]) ; 
}
  if (!(mu__boolexpr265)) mu__boolexpr264 = FALSE ;
  else {
  mu__boolexpr264 = (!(mu_Spy_known[mu_msgs[mu_pat2Set.mu_content[mu_i]].mu_expMsg2])) ; 
}
	      if (mu__boolexpr264) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr273;
  if (!((mu_IntruEmit2) == (mu_true))) mu__boolexpr273 = FALSE ;
  else {
  mu__boolexpr273 = ((mu_roleB[mu_j].mu_st) == (mu_B3)) ; 
}
  ...
  mu__boolexpr271 = ((mu_i) <= (mu_pat8Set.mu_length)) ; 
}
  if (!(mu__boolexpr271)) mu__boolexpr270 = FALSE ;
  else {
  mu__boolexpr270 = ((mu_pat8Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr270)) mu__boolexpr269 = FALSE ;
  else {
  mu__boolexpr269 = (mu_Spy_known[mu_pat8Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr269)) mu__boolexpr268 = FALSE ;
  else {
  mu__boolexpr268 = (!(mu_emit[mu_pat8Set.mu_content[mu_i]])) ; 
}
...
bool mu__boolexpr279;
  if (!((mu_IntruEmit2) == (mu_true))) mu__boolexpr279 = FALSE ;
  else {
  mu__boolexpr279 = ((mu_roleB[mu_j].mu_st) == (mu_B3)) ; 
}
  if (!(mu__boolexpr279)) mu__boolexpr278 = FALSE ;
  else {
  mu__boolexpr278 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr278)) mu__boolexpr277 = FALSE ;
  else {
  mu__boolexpr277 = ((mu_i) <= (mu_pat8Set.mu_length)) ; 
}
  if (!(mu__boolexpr277)) mu__boolexpr276 = FALSE ;
  else {
  mu__boolexpr276 = ((mu_pat8Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr276)) mu__boolexpr275 = FALSE ;
  else {
  mu__boolexpr275 = (mu_Spy_known[mu_pat8Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr275)) mu__boolexpr274 = FALSE ;
  else {
  mu__boolexpr274 = (!(mu_emit[mu_pat8Set.mu_content[mu_i]])) ; 
}
	      if (mu__boolexpr274) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr284;
  if (!((mu_roleB[mu_j].mu_st) == (mu_B1))) mu__boolexpr284 = FALSE ;
  else {
  mu__boolexpr284 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  ...
  mu__boolexpr280 = (!(mu_emit[mu_pat3Set.mu_content[mu_i]])) ; 
}
...
bool mu__boolexpr289;
  if (!((mu_roleB[mu_j].mu_st) == (mu_B1))) mu__boolexpr289 = FALSE ;
  else {
  mu__boolexpr289 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr289)) mu__boolexpr288 = FALSE ;
  else {
  mu__boolexpr288 = ((mu_i) <= (mu_pat3Set.mu_length)) ; 
}
  if (!(mu__boolexpr288)) mu__boolexpr287 = FALSE ;
  else {
  mu__boolexpr287 = ((mu_pat3Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr287)) mu__boolexpr286 = FALSE ;
  else {
  mu__boolexpr286 = (mu_Spy_known[mu_pat3Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr286)) mu__boolexpr285 = FALSE ;
  else {
  mu__boolexpr285 = (!(mu_emit[mu_pat3Set.mu_content[mu_i]])) ; 
}
	      if (mu__boolexpr285) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr295;
  if (!((mu_IntruEmit1) == (mu_true))) mu__boolexpr295 = FALSE ;
  else {
  mu__boolexpr295 = ((mu_roleA[mu_j].mu_st) == (mu_A2)) ; 
}
  if (!(mu__boolexpr295)) mu__boolexpr294 = FALSE ;
  else {
  mu__boolexpr294 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
  ...
  mu__boolexpr290 = (!(mu_emit[mu_pat3Set.mu_content[mu_i]])) ; 
}
...
bool mu__boolexpr301;
  if (!((mu_IntruEmit1) == (mu_true))) mu__boolexpr301 = FALSE ;
  else {
  mu__boolexpr301 = ((mu_roleA[mu_j].mu_st) == (mu_A2)) ; 
}
  if (!(mu__boolexpr301)) mu__boolexpr300 = FALSE ;
  else {
  mu__boolexpr300 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr300)) mu__boolexpr299 = FALSE ;
  else {
  mu__boolexpr299 = ((mu_i) <= (mu_pat3Set.mu_length)) ; 
}
  if (!(mu__boolexpr299)) mu__boolexpr298 = FALSE ;
  else {
  mu__boolexpr298 = ((mu_pat3Set.mu_content[mu_i]) != (0)) ; 
}
  if (!(mu__boolexpr298)) mu__boolexpr297 = FALSE ;
  else {
  mu__boolexpr297 = (mu_Spy_known[mu_pat3Set.mu_content[mu_i]]) ; 
}
  if (!(mu__boolexpr297)) mu__boolexpr296 = FALSE ;
  else {
  mu__boolexpr296 = (!(mu_emit[mu_pat3Set.mu_content[mu_i]])) ; 
}
	      if (mu__boolexpr296) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr302;
  if (!((mu_ch[2].mu_empty) == (mu_false))) mu__boolexpr302 = FALSE ;
  else {
  mu__boolexpr302 = ((mu_ch[2].mu_sender) != (mu_Intruder)) ; 
}
...
bool mu__boolexpr303;
  if (!((mu_ch[2].mu_empty) == (mu_false))) mu__boolexpr303 = FALSE ;
  else {
  mu__boolexpr303 = ((mu_ch[2].mu_sender) != (mu_Intruder)) ; 
}
	      if (mu__boolexpr303) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr304;
  if (!((mu_ch[3].mu_empty) == (mu_false))) mu__boolexpr304 = FALSE ;
  else {
  mu__boolexpr304 = ((mu_ch[3].mu_sender) != (mu_Intruder)) ; 
}
...
bool mu__boolexpr305;
  if (!((mu_ch[3].mu_empty) == (mu_false))) mu__boolexpr305 = FALSE ;
  else {
  mu__boolexpr305 = ((mu_ch[3].mu_sender) != (mu_Intruder)) ; 
}
	      if (mu__boolexpr305) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr306;
  if (!((mu_ch[1].mu_empty) == (mu_false))) mu__boolexpr306 = FALSE ;
  else {
  mu__boolexpr306 = ((mu_ch[1].mu_sender) != (mu_Intruder)) ; 
}
...
bool mu__boolexpr307;
  if (!((mu_ch[1].mu_empty) == (mu_false))) mu__boolexpr307 = FALSE ;
  else {
  mu__boolexpr307 = ((mu_ch[1].mu_sender) != (mu_Intruder)) ; 
}
	      if (mu__boolexpr307) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr310;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B3))) mu__boolexpr310 = FALSE ;
  else {
  mu__boolexpr310 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
  ...
  mu__boolexpr308 = (mu_judge( mu_ch[3].mu_msg, mu_roleB[mu_i].mu_B, mu_msgs[0] )) ; 
}
...
bool mu__boolexpr313;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B3))) mu__boolexpr313 = FALSE ;
  else {
  mu__boolexpr313 = ((mu_ch[3].mu_empty) == (mu_false)) ; 
}
  ...
  mu__boolexpr311 = (mu_judge( mu_ch[3].mu_msg, mu_roleB[mu_i].mu_B, mu_msgs[0] )) ; 
}
	      if (mu__boolexpr311) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr314;
  if (!(mu_flag_pat11)) mu__boolexpr314 = FALSE ;
  else {
  mu__boolexpr314 = (mu_B_known[mu_msg.mu_sencKey]) ; 
}
if ( mu__boolexpr314 )
{
...
bool mu__boolexpr317;
  if (!(mu_matchTmp( mu_roleB[mu_i].mu_locm3, mu_roleB[mu_i].mu_m3 ))) mu__boolexpr317 = FALSE ;
  else {
  mu__boolexpr317 = (mu_matchTmp( mu_roleB[mu_i].mu_locm2, mu_roleB[mu_i].mu_m2 )) ; 
}
  if (!(mu__boolexpr317)) mu__boolexpr316 = FALSE ;
  else {
  mu__boolexpr316 = (mu_matchNumber( mu_roleB[mu_i].mu_locx, mu_roleB[mu_i].mu_x )) ; 
}
  if (!(mu__boolexpr316)) mu__boolexpr315 = FALSE ;
  else {
  mu__boolexpr315 = (mu_matchNumber( mu_roleB[mu_i].mu_locp, mu_roleB[mu_i].mu_p )) ; 
}
if ( mu__boolexpr315 )
{
mu_ch[3].mu_empty = mu_true;
...
bool mu__boolexpr319;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B2))) mu__boolexpr319 = FALSE ;
  else {
  mu__boolexpr319 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr319)) mu__boolexpr318 = FALSE ;
  else {
  mu__boolexpr318 = (!(mu_roleB[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr321;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B2))) mu__boolexpr321 = FALSE ;
  else {
  mu__boolexpr321 = ((mu_ch[2].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr321)) mu__boolexpr320 = FALSE ;
  else {
  mu__boolexpr320 = (!(mu_roleB[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr320) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr324;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B1))) mu__boolexpr324 = FALSE ;
  else {
  mu__boolexpr324 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  ...
  mu__boolexpr322 = (mu_judge( mu_ch[1].mu_msg, mu_roleB[mu_i].mu_B, mu_roleB[mu_i].mu_m1 )) ; 
}
...
bool mu__boolexpr327;
  if (!((mu_roleB[mu_i].mu_st) == (mu_B1))) mu__boolexpr327 = FALSE ;
  else {
  mu__boolexpr327 = ((mu_ch[1].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr327)) mu__boolexpr326 = FALSE ;
  else {
  mu__boolexpr326 = (!(mu_roleB[mu_i].mu_commit)) ; 
}
  if (!(mu__boolexpr326)) mu__boolexpr325 = FALSE ;
  else {
  mu__boolexpr325 = (mu_judge( mu_ch[1].mu_msg, mu_roleB[mu_i].mu_B, mu_roleB[mu_i].mu_m1 )) ; 
}
	      if (mu__boolexpr325) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr329;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A3))) mu__boolexpr329 = FALSE ;
  else {
  mu__boolexpr329 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
...
bool mu__boolexpr331;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A3))) mu__boolexpr331 = FALSE ;
  else {
  mu__boolexpr331 = ((mu_ch[3].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr331)) mu__boolexpr330 = FALSE ;
  else {
  mu__boolexpr330 = (!(mu_roleA[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr330) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr334;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A2))) mu__boolexpr334 = FALSE ;
  else {
  mu__boolexpr334 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr334)) mu__boolexpr333 = FALSE ;
  else {
  mu__boolexpr333 = (!(mu_roleA[mu_i].mu_commit)) ; 
}
  if (!(mu__boolexpr333)) mu__boolexpr332 = FALSE ;
  else {
  mu__boolexpr332 = (mu_judge( mu_ch[2].mu_msg, mu_roleA[mu_i].mu_A, mu_roleA[mu_i].mu_m2 )) ; 
}
...
bool mu__boolexpr337;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A2))) mu__boolexpr337 = FALSE ;
  else {
  mu__boolexpr337 = ((mu_ch[2].mu_empty) == (mu_false)) ; 
}
  if (!(mu__boolexpr337)) mu__boolexpr336 = FALSE ;
  else {
  mu__boolexpr336 = (!(mu_roleA[mu_i].mu_commit)) ; 
}
  if (!(mu__boolexpr336)) mu__boolexpr335 = FALSE ;
  else {
  mu__boolexpr335 = (mu_judge( mu_ch[2].mu_msg, mu_roleA[mu_i].mu_A, mu_roleA[mu_i].mu_m2 )) ; 
}
	      if (mu__boolexpr335) {
		if ( ( TRUE  ) )
		  return;
...
bool mu__boolexpr339;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A1))) mu__boolexpr339 = FALSE ;
  else {
  mu__boolexpr339 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr339)) mu__boolexpr338 = FALSE ;
  else {
  mu__boolexpr338 = (!(mu_roleA[mu_i].mu_commit)) ; 
}
...
bool mu__boolexpr341;
  if (!((mu_roleA[mu_i].mu_st) == (mu_A1))) mu__boolexpr341 = FALSE ;
  else {
  mu__boolexpr341 = ((mu_ch[1].mu_empty) == (mu_true)) ; 
}
  if (!(mu__boolexpr341)) mu__boolexpr340 = FALSE ;
  else {
  mu__boolexpr340 = (!(mu_roleA[mu_i].mu_commit)) ; 
}
	      if (mu__boolexpr340) {
		if ( ( TRUE  ) )
		  return;
...
/********************
  Invariant records
 ********************/
int mu__invariant_342() // Invariant "secrecy1"
{
bool mu__quant343; 
mu__quant343 = TRUE;
{
...
bool mu__boolexpr345;
  if (!((mu_msgs[mu_i].mu_msgType) == (mu_nonce))) mu__boolexpr345 = FALSE ;
  else {
  mu__boolexpr345 = ((mu_msgs[mu_i].mu_noncePart) == (mu_Na)) ; 
}
  if (!(mu__boolexpr345)) mu__boolexpr344 = TRUE ;
  else {
  mu__boolexpr344 = ((mu_Spy_known[mu_i]) == (mu_false)) ; 
}
if ( !(mu__boolexpr344) )
...
bool mu__condition_346() // Condition for Rule "secrecy1"
{
...
{"secrecy1", &mu__condition_346, NULL, },
};
